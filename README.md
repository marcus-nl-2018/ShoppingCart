...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/marcus-nl-2018/ShoppingCart.git```> Select master Branch > Next > Next > Finish.
